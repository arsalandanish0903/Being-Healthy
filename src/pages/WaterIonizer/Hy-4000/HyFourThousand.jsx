        ...
        <div className="sm:px-8 lg:px-36 container mx-auto py-8 lg:py-16 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 space-y-6">
                ...
                <ul className="list-disc ml-6 text-gray-600">
                    ...
                    <li>Sterilization Ozone Mode</li>
                    <li>Advanced water purification</li>
                    <li>UV lamp</li>
                    <li>Comes with a touch sensor</li>
                    <li>Can be hanged or mounted on walls</li>
                    <li>Voltage: 220V AC 60Hz</li>
                    <li>Power consumption: 100W</li>
                    <li>Operation temperature: 5°C - 35°C</li>
                    <li>Dimensions: 350 (W) x 350 (H) x 150 (D) (mm)</li>
                    <li>Weight: 7 kg</li>
                </ul>
                ...
                <ul className="space-y-2 text-black" data-aos='fade-down'>
                    ...
                    <li className="flex items-center">
                        ...
                        <span className="ml-2">BH-4000</span>
                    </li>
                    <li className="flex items-center">
                ...
                <div className="flex items-center gap-4 bg-gray-100 p-4 rounded-lg">
                    ...
                    <OrderButtonMsg productName='BH-4000'/>
                </div>
            </div>

            <div className="bg-white shadow-lg rounded-lg p-6 flex items-center flex-col justify-center" data-aos='fade-right'>
                {/* Main Image Display */}
                <h1 className="font-bold text-4xl bg-black text-[#1ca3ec] p-4 rounded-md">BH-4000</h1>
